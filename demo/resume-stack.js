(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ResumeStack = {}));
  ...
  function detectTheme(preferred) {
      if (preferred === 'light')
          return 'light';
      if (preferred === 'dark')
          return 'dark';
  ...
  function getModalCSS(theme, blur) {
  ...
  class ResumeStack {
      ...
      init() {
          ...
          window.addEventListener('message', (event) => {
              if (event.origin !== PAYSTACK_CHECKOUT)
                  return;
  ...
  exports.ResumeStack = ResumeStack;
